...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out
        .println("My name is Roger Mendez and I am a junior at Florida Gulf Coast University, "
    ...
    // 3. int = 32-bit with min. value of -2^31 and max. value of 2^31-1
    // 4. Long = 64-bit with min value of -2^63 and max. value of 2^63-1, use this
